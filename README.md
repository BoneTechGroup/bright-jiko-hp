# 有輝接骨院／Bright整体 — 交通事故専門サイト制作

有輝接骨院／Bright整体の交通事故・むち打ち専門サイト。
...
- **テーマカラー**：ティファニーブルー（`--tiffany:#ef8240`）
...
電話 052-XXX-XXXX ／ LINE https://beauty.hotpepper.jp/kr/slnH000580938/ ／
愛知県名古屋市港区遠若町1丁目7 ハイツメイヨン1F
